...
import artiLeafBlack from '../../assets/logo/artileafBlackLine1.png'
import { Link, NavLink } from 'react-router';
import ThemeToggle from '../ThemeToggle/ThemeToggle';
import artiLeafBlue from '../../assets/logo/artileafBlueLine.png'
...
const Navbar = () => {
    ...
    const link = (
        <>
            ...
            <li className='text-primary dark:text-white'><NavLink to="/addArtifacts">About Us</NavLink></li>
            <li className='text-primary dark:text-white'><NavLink to="/addArtifacts">Contact Us</NavLink></li>
        </>
    )
    return (
        <div className='bg-base-100 shadow-sm dark:bg-black dark:border dark:border-b-secondary sticky top-0 z-20'>
                                    ...
                                    <div className="dropdown dropdown-end ">
                                        ...
                                        <ul
                                            ...
                                            <div className='px-1 text-primary  md:px-2 text-center' >
                                                ...
                                                <li>
                                                    <Link to="/myArtifactsRoute">
                                                        <p className="hover:text-secondary dark:text-white">My Artifacts</p>
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link to="/likedArtifactsRoute">
                                                        <p className="hover:text-secondary dark:text-white">Liked Artifacts</p>
                                                    </Link>
                                                </li>
