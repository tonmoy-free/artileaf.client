        ...
        <div className="w-11/12 mx-auto mt-0 md:mt-18 lg:mt-20">
            ...
            <div className="hero-content flex p-4">
                ...
                <div className=" w-full  shadow-2xl flex-1 rounded-2xl">
                    ...
                    <div className="collapse collapse-arrow bg-base-100 border border-base-300 mt-1 dark:bg-primary dark:hover:border-secondary">
                        <input type="radio" name="my-accordion-2" />
                        <div className="collapse-title font-semibold dark:text-white">What kind of artifacts can be submitted?</div>
                        <div className="collapse-content text-sm dark:text-white">You can submit any historical item — tools, weapons, writings, sculptures, documents, etc. — as long as it has historical significance and accurate context.</div>
                    </div>

                    <div className="collapse collapse-arrow bg-base-100 border border-base-300 mt-1 dark:bg-primary dark:hover:border-secondary">
                        <input type="radio" name="my-accordion-2" />
                        <div className="collapse-title font-semibold dark:text-white">What is <span className='text-primary dark:text-white'>ArtiLeaf </span>
                            ?
                        </div>
                        <div className="collapse-content text-sm dark:text-white"> web application for tracking historical artifacts such as the Rosetta Stone, the Antikythera Mechanism, etc. The application will allow users to browse artifacts, view details, and add their own entries. The system will also allow users to like artifacts and keep track of their own contributions.</div>
                    </div>
                    <div className="collapse collapse-arrow bg-base-100 border border-base-300 mt-1 dark:bg-primary dark:hover:border-secondary">
                        <input type="radio" name="my-accordion-2" />
                        <div className="collapse-title font-semibold dark:text-white">Who can add artifacts?</div>
                        <div className="collapse-content text-sm dark:text-white">Any registered user can add artifacts to the platform. Simply log in and go to the "Add Artifact" section to contribute.</div>
                    </div>
                </div>
            </div>
        </div>
